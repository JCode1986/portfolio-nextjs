...
export const projects = [
  {
    ...
    repositoryUrl: '',
    heroImage: '/project-previews/wherekeep-transparent.png',
  ...
  },
  {
    ...
    liveUrl: 'https://qr-generator-puce-phi.vercel.app/',
    repositoryUrl: '',
    heroImage: '/project-previews/quickqr-transparent.png',
    imageAlt: 'QuickQR responsive QR code generator preview shown on desktop and mobile devices',
    ctaPrimary: 'View Live Product',
    ctaSecondary: 'Read Case Study',
    accent: 'purple',
    featured: true,
